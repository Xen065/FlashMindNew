# Windows Setup Guide for FlashMind Android App

## Important: This is NOT a Web Server Project

**FlashMind is a native Android mobile application**, not a web application. This means:
...
**What you should see:**
- Purple gradient header with "FlashMind" title
...
│   ├── src/
│   │   ├── main/
│   │   │   ├── java/com/flashmind/    ← Kotlin source code
...
3. **Review the Code:**
   - Open `app/src/main/java/com/flashmind/MainActivity.kt`
   - Explore the UI layouts in `app/src/main/res/layout/`
   - Check the database models in `app/src/main/java/com/flashmind/data/models/`
