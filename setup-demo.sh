...
echo ""
echo "═══════════════════════════════════════════"
echo "🚀 FlashMind Admin System Setup"
echo "═══════════════════════════════════════════"
echo ""
...
psql -U postgres -tc "SELECT 1 FROM pg_database WHERE datname = 'flashmind'" | grep -q 1 || \
    psql -U postgres -c "CREATE DATABASE flashmind"
echo "✅ Database ready"
echo ""
