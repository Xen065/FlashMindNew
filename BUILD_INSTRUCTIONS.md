# FlashMind - Build Instructions

This document provides step-by-step instructions for building and running the FlashMind Android app.
...
1. **App Icon**: "FlashMind" appears in app drawer
2. **Launch Screen**: Purple gradient header with "FlashMind" title
3. **Dashboard**:
...
1. **Create Keystore** (first time only):
   ```bash
   keytool -genkey -v -keystore flashmind-release.keystore \
           -alias flashmind -keyalg RSA -keysize 2048 -validity 10000
   ```
