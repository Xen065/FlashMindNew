# FlashMind Backend API

REST API server for the FlashMind learning platform with spaced repetition.
...
JWT_SECRET=flashmind_secret_key_2024_change_in_production
JWT_EXPIRE=7d
...
**Solution:**
- Make sure the database `flashmind` exists in PostgreSQL
...
| DB_NAME | Database name | flashmind |
