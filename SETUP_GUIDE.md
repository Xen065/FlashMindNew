# FlashMind - Complete Setup Guide for Windows

This guide will help you set up the complete FlashMind platform on your Windows laptop with **no prior web development experience required**.
...
5. Database name: `flashmind`
6. Click "Save"

You should now see "flashmind" in the database list!
...
You should see:
```
✅ Created user: demo@flashmind.com / demo123
✅ Created 4 courses
...
You should see:
```
🚀 FlashMind API Server is running!
🚀 Port: 5000
...
- [ ] Can login with demo@flashmind.com / demo123
