...
import './AdminCourseCategories.css';
...
const AdminCourseCategories = () => {
  ...
  if (loading) {
    return <div className="loading-container"><div className="loading-spinner"></div><p>Loading categories...</p></div>;
  }
  ...
  return (
    <div className="admin-categories-page">
      <div className="page-header">
        <h1>Course Categories Management</h1>
